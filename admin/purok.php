                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <a type="button" href="#edit" data-bs-toggle="modal"
                                                                ...
                                                                title="Edit Purok" onclick="editPurok(this)"
                                                                data-name="<?= $row['name'] ?>"
                                                            ...
                                                            <a type="button" data-bs-toggle="tooltip"
                                                                href="model/remove_purok.php?id=<?= $row['id'] ?>"
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_purok.php">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter purok name" name="purok"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label>Purok Details(Optional)</label>
                                    <textarea class="form-control" placeholder="Set Bounderies for each Purok"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/edit_purok.php">
                                <div class="form-group">
                                    <label>Purok Name</label>
                                    <input type="text" class="form-control" id="purok" placeholder="Enter Purok Name"
                                        name="purok" required>
                                </div>
                                <div class="form-group">
                                    <label>Purok Details(Optional)</label>
                                    <textarea class="form-control" id="details"
                                        placeholder="Set Bounderies for each Purok" name="details"></textarea>
                                </div>
