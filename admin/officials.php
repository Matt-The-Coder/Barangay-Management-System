                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-wrap pb-2 justify-content-between">
                                        ...
                                        <div class="px-2 pb-2 pb-md-0 text-center">
                                            <img src="assets/img/brgy-logo.png" class="img-fluid" width="100"
                                    ...
                                    <div class="card-head-row">
                                        ...
                                        <div class="card-tools">
                                            <a href="#add" data-bs-toggle="modal"
                                                class="btn btn-info float-end btn-sm text-white">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            style="width:100%" id="tblofficial">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a type="button" href="#edit" data-bs-toggle="modal"
                                                            ...
                                                            title="Edit Position" onclick="editOfficial(this)"
                                                            data-id="<?= $row['id'] ?>" data-name="<?= $row['name'] ?>"
                                                            data-chair="<?= $row['chair_id'] ?>"
                                                            data-pos="<?= $row['pos_id'] ?>"
