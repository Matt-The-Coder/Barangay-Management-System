...
if ($nat == 0) {
    if (!empty($fname)) {
        ...
        if (!empty($profile) && !empty($profile2)) {
            ...
            $query = "INSERT INTO tblresident (`national_id`,citizenship,`picture`, `firstname`, `middlename`, `lastname`, `alias`, `birthplace`, `birthdate`, age, `civilstatus`, `gender`, `purok`, `household_id`, `voterstatus`, `phone`, `email`, occupation, `address`) 
							VALUES ('$national_id','$citizen','$profile','$fname','$mname','$lname','$alias','$bplace','$bdate',$age,'$cstatus','$gender','$purok','$household_id','$vstatus','$number','$email','$occupation','$address')";
            ...
            $query = "INSERT INTO tblresident (`national_id`, citizenship, `picture`, `firstname`, `middlename`, `lastname`, `alias`, `birthplace`, `birthdate`, age, `civilstatus`, `gender`, `purok`, `household_id`, `voterstatus`, `phone`, `email`, occupation, `address`) 
							VALUES ('$national_id','$citizen','$newName','$fname','$mname','$lname','$alias','$bplace','$bdate',$age,'$cstatus','$gender','$purok','$household_id','$vstatus','$number','$email','$occupation','$address')";
            ...
            $query = "INSERT INTO tblresident (`national_id`, citizenship, `picture`,`firstname`, `middlename`, `lastname`, `alias`, `birthplace`, `birthdate`, age, `civilstatus`, `gender`, `purok`, `household_id`, `voterstatus`, `phone`, `email`, occupation, `address`) 
							VALUES ('$national_id','$citizen','person.png','$fname','$mname','$lname','$alias','$bplace','$bdate',$age,'$cstatus','$gender','$purok','$household_id','$vstatus','$number','$email','$occupation','$address')";
