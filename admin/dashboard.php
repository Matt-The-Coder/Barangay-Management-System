                        ...
                        <div class="col-md-4">
                            <div class="card card-stats card-secondary card-round">
                                ...
                                <div class="card-body card-round" style="background: #6e4caa;">
                                    <a href="resident_info.php?state=all" class="card-link text-light text-decoration-none">Total Population
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card card-stats card-primary card-round">
                                ...
                                <div class="card-body card-round" style="background: #3666b4;">
                                    <a href=" resident_info.php?state=male" class="card-link text-light text-decoration-none">Total Male </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card card-stats card-round" style="background-color:#F06292; color:#fff">
                                ...
                                <div class="card-body card-round" style="background: #db5783;">
                                    <a href=" resident_info.php?state=female" class="card-link text-light text-decoration-none">Total Female
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="card card-stats card-success card-round">
                                    ...
                                    <div class="card-body card-round" style="background: #139145;">
                                        <a href=" resident_info.php?state=voters" class="card-link text-light text-decoration-none">Total Voters
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card card-stats card-danger card-round">
                                    ...
                                    <div class="card-body card-round" style="background: #c03f54;">
                                        <a href="resident_info.php?state=non_voters" class="card-link text-light text-decoration-none">Total Non-Voters </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card card-stats card-round" style="background-color:#BA68C8; color:#fff">
                                    ...
                                    <div class="card-body card-round" style="background: #a45ab1;">
                                        <a href="purok_info.php?state=precinct" class="card-link text-light text-decoration-none">Precint
                                            Information</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card card-stats card-round" style="background-color:#26A69A; color:#fff">
                                    ...
                                    <div class="card-body card-round" style="background: #219589;">
                                        <a href="purok_info.php?state=purok" class="card-link text-light text-decoration-none">Purok
                                            Information</a>
                                    </div>
                                </div>
                            </div>
