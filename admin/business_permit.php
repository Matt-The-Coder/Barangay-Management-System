                ...
                <div class="panel-header">
                    <div class="page-inner">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="fw-bold">Resident Certificate</h2>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <table id="residenttable"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= !empty($row['owner2']) ? ucwords($row['owner1'] . ' & ' . $row['owner2']) : $row['owner1'] ?>
                                                    </td>
                                                    <td><?= $row['nature'] ?></td>
                                                    <td><?= $row['applied'] ?></td>
                                                    <?php if (isset($_SESSION['username'])) : ?>
                                                    <td>
                                                        <div class="form-button-action">
                                                            <a type="button" data-bs-toggle="tooltip"
                                                                ...
                                                                data-original-title="Generate Permit">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_permit.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-2" placeholder="Enter Owner Name"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="Sari-Sari Store/Warter Refill Station" name="nature" required>
                                </div>
                                <div class="form-group">
                                    <label>Date Applied Nature</label>
                                    <input type="date" class="form-control" name="applied" value="<?= date('Y-m-d'); ?>"
                                        required>
                                </div>
