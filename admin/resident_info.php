        ...
        <div class="main-panel">
            <div class="content">
                ...
                <div class="page-inner">
                    ...
                    <?php endif ?>
                    <div class="row mt--2">
                        <div class="col-md-<?= $state != 'voters' ? '9' : '9' ?>">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="residenttable" class="display table nowrap table-borderless table-hover table-sm align-middle mb-0 bg-white" style="width:100%">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="icon-big text-center">
                                                    <i class="ri-fingerprint-line" style="font-style: 3rem;"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="icon-big text-center">
                                                    <?php
                                                    if ($state == 'male') {
                                                        echo '<i class="ri-men-line" style="font-style: 3rem;"></i>';
                                                    } elseif ($state == 'female') {
                                                        echo '<i class="ri-women-line" style="font-style: 3rem;"></i>';
                                                    } elseif ($state == 'voters') {
                                                        echo '<i class="ri-user-follow-line" style="font-style: 3rem;"></i>';
                                                    } elseif ($state == 'non_voters') {
                                                        echo '<i class="ri-user-unfollow-line" style="font-style: 3rem;"></i>';
                                                    } else {
                                                        echo '<i class="ri-team-line" style="font-style: 3rem;"></i>';
                                                    }
                                                    ?>
                                                </div>
                                            </div>
