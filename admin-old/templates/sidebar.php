        ...
        <div class="sidebar-content">
            <div class="user">
                <div class="avatar-sm float-left mr-2">
                    ...
                    <img id="image"
                        src="<?= preg_match('/data:image/i', $_SESSION['avatar']) ? $_SESSION['avatar'] : 'assets/uploads/avatar/' . $_SESSION['avatar'] ?>"
                ...
                <div class="info">
                    <a data-bs-toggle="collapse" class="text-decoration-none"
                        href="<?= isset($_SESSION['username']) && ($_SESSION['role'] == 'administrator' || $_SESSION['role'] == 'staff') ? '#collapseExample' : 'javascript:void(0)' ?>"
                        aria-expanded="true">
                        <span id="username">
                            <?= isset($_SESSION['username']) ? ucfirst($_SESSION['username']) : 'Guest User' ?>
                        </span>
                        <span id="role"
                            class="user-level"><?= isset($_SESSION['role']) ? ucfirst($_SESSION['role']) : 'Guest' ?></span>
            ...
            <ul class="nav nav-danger">
                <li
                    class="nav-item <?= $current_page == 'dashboard.php' || $current_page == 'resident_info.php' || $current_page == 'purok_info.php'  ? 'active' : null ?>">
                ...
                <li
                    class="nav-item <?= $current_page == 'resident.php' || $current_page == 'generate_resident.php' ? 'active' : null ?>">
                ...
                <li
                    class="nav-item <?= $current_page == 'resident_certification.php' || $current_page == 'generate_brgy_cert.php' ? 'active' : null ?>">
                ...
                <li
                    class="nav-item <?= $current_page == 'resident_indigency.php' || $current_page == 'generate_indi_cert.php' ? 'active' : null ?>">
                ...
                <li
                    class="nav-item <?= $current_page == 'business_permit.php' || $current_page == 'generate_business_permit.php' ? 'active' : null ?>">
                ...
                <li
                    class="nav-item <?= $current_page == 'purok.php' || $current_page == 'position.php' || $current_page == 'chairmanship.php' || $current_page == 'precinct.php' || $current_page == 'users.php' || $current_page == 'support.php' || $current_page == 'backup.php' ? 'active' : null ?>">
                    <a href="#settings" data-bs-toggle="collapse" class="collapsed text-decoration-none"
                        aria-expanded="false">
                        <i class="ri-settings-line fs-3"></i>
                        <p>Settings</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse <?= $current_page == 'purok.php' || $current_page == 'household.php' || $current_page == 'position.php'  || $current_page == 'precinct.php' || $current_page == 'chairmanship.php' || $current_page == 'users.php' || $current_page == 'support.php' || $current_page == 'backup.php' ? 'show' : null ?>"
                        id="settings">
