                ...
                <div class="panel-header">
                    <div class="page-inner">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="fw-bold">Generate Permit</h2>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            ...
                                            <div class="text-center">
                                                <h2 class="mt-4 fw-bold mb-5" style="font-size:38px;color:darkblue">
                                                    BARANGAY BUSINESS CLEARANCE</h2>
                                            </div>
                                            <h3 class="mt-5 fw-bold">GRANTED TO:</h3>
                                            <div class="text-center pt-4">
                                                <h2 class="mt-4 fw-bold mb-0"><?= ucfirst($permit['name']) ?></h2>
                                                <hr class="w-50 mt-0 mb-0 mx-auto" style="border-top: 3px solid black;">
                                                <h3 class="mt-0">NAME OF BUSINESS OR ESTABLISHMENT</h3>
                                            </div>
                                            <div class="text-center pt-4 mb-5">
                                                <h2 class="mt-4 fw-bold mb-0">
                                                    <?= empty($permit['owner2']) ? $permit['owner1'] : ucwords($permit['owner1'] . ' & ' . $permit['owner2']) ?>
                                                </h2>
                                                <hr class="w-50 mt-0 mb-0 mx-auto" style="border-top: 3px solid black;">
                                                <h3 class="mt-0">NAME OF BUSINESS OR ESTABLISHMENT</h3>
                                            </div>
                                            <h3 class="mt-5" style="text-indent: 40px;">This clearance is granted in
                                                ...
                                                Treasurer.</h3>
                                            <h3 class="mt-3" style="text-indent: 40px;">This is non-transferable and
                                                ...
                                                <span style="font-size:26px"><?= ucwords($town) ?>.
                                            </h3>
                                            <h3 class="mt-5">Given this <span class="fw-bold"
                                                    style="font-size:26px"><?= date('m/d/Y') ?></span> at <span
                                                    style="font-size:26px"><?= ucwords($brgy . ', ' . $town) ?></span>.
                                            </h3>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="p-3 text-right mr-5" style="margin-top:120px">
                                                <h2 class="fw-bold mb-0 text-uppercase"><?= ucwords($captain['name']) ?>
                                                </h2>
                                        ...
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <h5 class="mb-0"><i>Isuued at.</i>: <?= ucwords($brgy . ',' . $town) ?></h5>
                                            <h5 class="mb-0"><i>OR No.</i>:_____________</h5>
                                        </div>
                                        <p class="ml-3"><i>(This permit, while in force, shall be posted in a
                                                conspicious place in the business premises.)</i></p>
                                    </div>
                                </div>
                            </div>
                        </div>
