function editRequest(that) {
    id = $(that).attr('data-id');
    fname = $(that).attr('data-fname');
    mname = $(that).attr('data-mname');
    lname = $(that).attr('data-lname');
    type = $(that).attr('data-type');
    pickup = $(that).attr('data-pickup');
    payment = $(that).attr('data-payment');
    reference = $(that).attr('data-reference');
    purpose = $(that).attr('data-purpose');
    date_req = $(that).attr('data-date_req');
    docstatus = $(that).attr('data-docstatus');
    tracking_code = $(that).attr('data-tracking_code');
...
function editResident(that) {
    ...
    household_id = $(that).attr('data-household_id');
