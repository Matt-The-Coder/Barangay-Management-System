                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="text-center">
                                                <h2 class="mt-4 fw-bold mb-5" style="font-size:38px;color:darkblue">
                                                    CERTIFICATE OF INDIGENCY</h2>
                                            </div>
                                            <h3 class="mt-5 fw-bold">TO WHOM IT MAY CONCERN:</h3>
                                            <h3 class="mt-3" style="text-indent: 40px;">This is to certify that <span
                                                    class="fw-bold"
                                                    style="font-size:26px"><?= ucwords($resident['firstname'] . ' ' . $resident['middlename'] . ' ' . $resident['lastname']) ?></span>,
                                                of legal age, <span class="fw-bold"
                                                    style="font-size:26px"><?= ucwords($resident['gender']) ?></span>,
                                                <span class="fw-bold"
                                                    style="font-size:26px"><?= ucwords($resident['civilstatus']) ?></span>,
                                                and Filipino is a resident of <span class="fw-bold"
                                                    style="font-size:26px"><?= ucwords($brgy) ?></span> and that he/she
                                                is one of indigents in our barangay.
                                            </h3>
                                            <h3 class="mt-3" style="text-indent: 40px;">This certification/clearance is
                                                hereby issued to the above-named person for whatever legal purpose it
                                                may serve him/her best.</h3>
                                            <h3 class="mt-5">Given this <span class="fw-bold"
                                                    style="font-size:26px"><?= date('m/d/Y') ?></span> at the office of
                                                the Punong Barangay, <span class="fw-bold"
                                                    style="font-size:26px"><?= ucwords($brgy) ?></span>
                                                this Municipality, Philippines.</h3>
                                        </div>
                                        <div class="col-md-12">
